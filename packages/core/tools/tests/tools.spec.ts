...
import LlmRuntime, { type ContentBlock, createUserMessage, HarnessError, ToolCallId } from '@deepseek-ai/dsh-llm'
...
describe('ToolRuntime', () => {
  it('shares the agent-loop scheduler key across package instances', () => {
